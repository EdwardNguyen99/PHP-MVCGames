...
<div class="container">
                ...
                <div class="col-md-12">
                    ...
                    <p class="lead">Các tin tức công nghệ, hướng dẫn sử dụng, giới thiệu games, tin tức khuyến mãi từ hệ thống cửa hàng của chúng tôi sẽ được thường xuyên vào đây để thông tin và hỗ trợ quý vi
                    </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="box-image-text blog">
                                <div class="top">
                                    <div class="image">
                                        <img src="<?=$row['urlHinh']?> " class="img-responsive">
                                    </div>
                                    <div class="bg"></div>
                                    <div class="text">
                                        <p class="buttons">
